      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:px-6 bg-blue-700 text-white">
            ...
            <p className="mt-1 text-sm">Hello, {user?.firstName} {user?.lastName}</p>
          </div>
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="bg-gray-50 px-5 py-3">
              <div className="text-sm">
                <Link to="/shipments" className="font-medium text-blue-600 hover:text-blue-500">View all</Link>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="bg-gray-50 px-5 py-3">
              <div className="text-sm">
                <Link to="/shipments/delivered" className="font-medium text-blue-600 hover:text-blue-500">View all</Link>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="bg-gray-50 px-5 py-3">
              <div className="text-sm">
                <Link to="/shipments/pending" className="font-medium text-blue-600 hover:text-blue-500">View all</Link>
              </div>
            </div>
          </div>
        </div>
